...
<ROOM THREE-CONNECTOR
      ...
      (ENTER
       <EXECUTE ()
		<COND (<NOT <FSET? ,REAGENT ,SOLVED>>
		       <PARTY-ADD ,HURTH>
		       <FSET ,PRAXIX ,LIT>
		       <SETG RED-ROCK-COUNT 1>
		       ;"Assume used only once in saving Bergon"
		       <FSET ,REAGENT ,SOLVED>
		       <TRAVEL-COMMANDS ,PRAXIX
					,CAST-COMMAND
					,MIX-COMMAND
					,EXAMINE-COMMAND>
		       <MOVE ,SPYGLASS ,INVENTORY>
		       ;"Assume found spyglass"
		       <TELL "[Part III]" CR CR>
		       <TELL
"[Tag has given the red rock to Praxix, who has crushed it into a powder;
invisibility is now one of P's spells.]" CR CR>)
		      (T
		       <REMOVE ,SPIRIT-STONE>
...
drawing a deep breath. \"The Anvil lies where it has rested since the
dawning of the Age; on the Misty Isle, far to the south. This is where
your efforts lead - the end of your Journey, for good or ill.\"" CR CR>
		<TELL
...
entered that mist has returned alive. But that is where the Anvil lies;
it has a great power within it, and that is our last hope against the
scourge from the North.\"" CR CR>
		<TELL
"\"Rest here this night, and start fresh in the morning. The road to
Zan lies here,\" he continued, taking out a crude map, \"Zan should be
a two-day march at worst.\" He paused, as if unsure of how to say what
was to follow. \"Word of your quest is in the air; I do not know how.
The " ,BAD-GUY " has spies everywhere, and it is said that the town of Zan
is in his thrall. Be careful! Do not tarry in Zan; the sooner you are on
the seas, the better!\"">>)
      (EXIT
       <EXECUTE ()
		<SETG SUBGROUP-MODE <>>>) 
...
ionized air. Soon, we were in the midst of a downpour, and we hustled for
cover into a nearby shallow cave." CR CR>
	       <TELL
...
<ROUTINE DEMON-KILLS-AT-OUTSKIRTS ()
	 ...
	 <TELL
"Black as the darkest caverns, it seemed to hover, formless, in the sky above
...
honor should go to " D ,DEMON-VICTIM ".\"" CR CR>
	 <TELL
...
day when the ground is flooded. You never see them at night, which is fine
with me, but they can be quite trying at times like these.\"">
...
was carrying in his sack. It turned out that he was carrying only a few
stones, presumably from the trove in the castle's dungeons, as well
as a large, peculiar black stone that crumbled to the same consistency
as that of the magical reagent we had gotten from Garlimon. Carefully,
Praxix broke off a piece of the reagent and placed it among his own
powders.">)>)>

<ROOM ZAN-CAVE
      (TRAVEL-COMMANDS LEAVE-COMMAND STAY-COMMAND NUL-COMMAND)
...
he curled up into a ball and fell into a deep sleep.">
	      ...
	      (LEAVE
	       <COND (<NOT <F&SET? ,HERE ,BLUE-MIX>>
		      <SETG SUBGROUP-MODE <>>
		      <REMOVE-TRAVEL-COMMAND ,HERE ,STAY-COMMAND>
		      <TELL
...
The earth seemed unnaturally still as we trudged through the mudwarg infested
pools. But Umber had been right, or so it seemed - the mudwargs had no
taste for those that travelled in darkness." CR CR>
			     <TELL
...
powder.\"" CR CR>
			     <TELL
"\"He's a good sleeper?\" I tried, though even I was not convinced it was
possible." CR CR>
			     <TELL
"\"Perhaps,\" Praxix replied. \"But I wonder how it is that Umber possessed
the black reagent, and at how conveniently it was placed at our disposal.\"
...
sounded callous, but it was not - we simply had no choice but to continue
down the road, and we did so without further incident.">)>
		      <TELL CR CR
"It was nearly twilight when we reached the outskirts of Zan. Many homes were
scattered in the hillsides that surrounded this
busy port, but the main thoroughfare was nearly deserted. As we approached
the center of town, two shops loomed before us: a curio shop and a
general store.">
...
that seemed to emanate from within the enchanted staff.">)
...
<ROUTINE MUDWARG-TELL ()
	 <TELL
" \"I was about
to tell you why it is safer in here.\" He motioned us to gather around him,
and then, in a conspiratory voice, he whispered a single word, 'mudwargs,'
...
<OBJECT ZAN-1-GENERAL-STORE
	...
	(ACTION
	 <ACOND ()
		(EXAMINE:REMOVE
		 <TELL
"From all appearances, the general store was closed for the night." CR CR>
		 <TELL
"\"An exciting place,\" commented " ACT ", \"Let's hope something around
here is open.\"">)>)>

<COMMAND CURIO-SHOP>
<COMMAND (GENERAL-STORE GENL-STORE)>

<ROOM ZAN-1
      (TRAVEL-COMMANDS PROCEED-COMMAND CURIO-SHOP-COMMAND
       		       GENERAL-STORE-COMMAND)
      (GRAPHIC G-ZAN ;G-ZAN-1)
      (ACTION
       <ACOND ()
	      (SCOUT:REMOVE
	       <TELL
...
tone, \"If you must, have yourselves a quick look around.\"">
	       <MOVE-TO ,CURIO-SHOP>)
	      (GENERAL-STORE:REMOVE
	       <TELL
"We approached the general store, but it had already closed for the
evening." CR CR>
	       <TELL
...
<ROOM ZAN-2
      (TRAVEL-COMMANDS TAVERN-COMMAND INN-COMMAND WHARF-COMMAND
       		       BACK-COMMAND)
      (GRAPHIC G-ZAN ;G-ZAN-2)
      (FLAGS DONT-SCOUT)
      (ACTION
       <ACOND ()
	      (GET-ADVICE:REMOVE
	       <TELL
"It seemed there were two choices of how to spend the night, but we
were all looking forward to a night of comfort at the inn.">
	       <COND (,INN-TALK
		      <TELL CR CR
...
night.\"">)>
	      ...
	      (BACK
	       ...
	       <TELL
"Going back to the shops was no longer an alternative; they were closed
now, and their lights darkened. Only the tavern and inn remained open,
though there was some activity also before us, at the wharf.">)
	      (WHARF:REMOVE
	       <CHANGE-TRAVEL-COMMAND ,HERE ,BACK-COMMAND ,CAMP-OUT-COMMAND>
	       <TELL
"Although it was dark, the wharf was brightly lit. There were about a
dozen piers in different stages of decay, but only three ships were in
port. On each, the captain could be seen, giving orders to the deckhands
who numbered from two to five." CR CR>
	       <TELL
"Each ship was distinctly marked with a name and an emblem, as was the
custom. From left to right, they were the 'Elfentide', the 'South
Seas', and the 'Zephyr.'" CR CR>
	       <TELL
...
and townsfolk while ">
	       <COND (,DEMON-SEARCHING?
		      <TELL "only one table was occupied, and nobody there
was eating." CR CR>)
		     (T
		      <TELL "none of the tables in the dining area was
occupied." CR CR>)>
	       <TELL
"Nonetheless, we sat ourselves down for dinner, with the expectation of
checking out the wharf later that evening.">
	       <MOVE-TO ,ZAN-TAVERN>) 
	      (INN
	       <CHANGE-TRAVEL-COMMAND ,HERE ,BACK-COMMAND ,CAMP-OUT-COMMAND>
	       <COND (<OR <FSET? ,INN ,BLACK-MIX>
			  <NOT <FSET? ,WHARF ,SEEN>>>
		      <FSET ,HERE ,BLACK-MIX>
		      <REMOVE-TRAVEL-COMMAND ,HERE ,INN-COMMAND>)>
	       <COND (<FSET? ,INN ,SEEN>
		      <TELL
...
his mouth.">)
		     (T
		      <TELL
"We entered the inn. Inside, an old man, with a long, scruffy beard, was
standing behind the counter." CR CR>
		      <TELL
"\"Can I help you folks?\" he said, flashing a nearly toothless smile.">)>
	       <MOVE-TO ,INN>)
	      (CAMP-OUT
...
had little time left before our boat would depart."> 
		      <REMOVE-ALL ,INVENTORY ,JAIL-STORAGE>
		      <MOVE-TO ,JAIL>)
		     (,DEMON-SEARCHING?
		      <SETG DEMON-SEARCHING? <>>
		      <TELL
"It seemed best to avoid the inn, so we found" ,COMFORTABLE-SPOT CR CR>
		      <GRAPHIC ,G-ASSASSINS>
		      <TELL
      ...
      (ENTER
       <EXECUTE ()
		...
		<COND (<AND <NOT <IN-PARTY? ,ESHER>>
			    <NOT <IN-PARTY? ,MINAR>>
			    <NOT <IN-PARTY? ,HURTH>>>
		       <PUT <GETPT ,BERGON ,P?PROVISION-COMMANDS>
			    1
			    ,LOOK-AROUND-COMMAND>)>>)
      (ACTION
       <ACOND ("AUX" CNT CHR)
...
to explore on his own.">
	       <COND (<G? ,PARTY-MAX 3>
		      <TELL
" This seemed a good enough idea for the rest of
us and soon we had separated to the far corners of the shop.">)>
	       <TELL " Only
...
expect you'll be able to afford it.\""> 
	       ...
	       <CIT ,TAG ,BUY-COMMAND ,INVENTORY-COMMAND>
...
silver to make the purchase.">
	       <CIT ,TAG ,TRADE-COMMAND ,INVENTORY-COMMAND>
	       <CHANGE-CIT ,PRAXIX 1 ,STEAL-STONE-COMMAND>)
	      (SELL
	       <TELL
"It occurred to me that selling something to the proprietor might help,
but it seemed best to reserve this option as a last resort.">
	       <COND (<IN? ,GRAY-STONE ,HERE>
		      <CIT ,TAG ,BUY-COMMAND ,INVENTORY-COMMAND>)
		     (T
		      <CIT ,TAG ,INVENTORY-COMMAND>)>)
	      (TRADE
...
who examined it with keen interest." CR CR>
		      <TELL
...
interested in us? Nobody here knows of our coming, no less who
we are, and what our purpose is.\" And as if to prove that there was
nothing suspicious going on, he turned and stared at the men at the table.
As one, they turned away and their conversation grew quieter. In the dim
light of the tavern it appeared that Bergon blushed." CR CR>
		 <TELL
"\"This is grave, indeed,\" Praxix said, voice lowered. \"They appear to know
us, yet they are no friends of ours.\"">)>)>

<COMMAND ORDER-MEAL>

<GLOBAL INN-TALK <>>

<ROUTINE TAVERN-TALK ("AUX" (TMP <GET-TEMP>) (CNT <MIN .TMP 2>))
	 <COND (<ZERO? .CNT>
		<SETG INN-TALK T>
		<TELL
"The man to my left was now speaking. \"...at the inn? Does it matter
how we accomplish this task?\" A long silence followed.">)
	       (<EQUAL? .CNT 1>
		<TELL
"The man farthest away spoke. \"I am less concerned about what you
desire than about the size of our reward. This is not a barbarian land
like the northern hinterlands, with all respect. If we get caught, there
will be hell to pay.\"">)
	       (<EQUAL? .CNT 2>
		<TELL
"It was the man whose face I could not see who had the last word. His
voice was deep and rumbling, and an involuntary shudder ran through
my body." CR CR>
		<TELL
"\"Hell to pay? What can you know of hell?\" He had raised his voice,
and now spoke more softly, in unctuous tones. \"You must do what is
necessary; how you do so is not my concern. Do not fail, and
your reward will be befitting of they that walk with kings. I must leave
Zan at once, but I shall return in three days. I know I have chosen
well here today.\"">
...
"I walked out of the tavern and around back,
waiting there until I had materialized (an odd sensation that would be
quite difficult to describe.) And then, I returned to the tavern,
receiving little attention, and sat again at the table.">
...
<ROOM INN
      ...
      (GRAPHIC G-INNKEEPER)
      (FLAGS DONT-SCOUT FORBIDDING)
      (CAST-LIMIT 2)
      ;(ENTER FSET-SEEN)
      (EXIT
       <EXECUTE ()
		<COND (<AND <FSET? ,BEND-WILL-SPELL ,TRAPPED>
			    <NOT <F&SET? ,BEND-WILL-SPELL ,DEAD>>
			    <IN-PARTY? ,ESHER>>
		       <TELL CR CR
"Back outside, Praxix explained the odd happenings inside the inn." CR CR>
		       <TELL
"\"It seems that the mixture I cast was quite effective. You see, Esher
had just made one of his typically insulting remarks, and I, not
unnaturally, started to get angry. But what I was fantasizing, the innkeeper
actually did! I have not heard of such a mind-controlling spell, but I
cannot doubt its power." CR CR>
		       <TELL
...
then started doing some paperwork behind his desk.">
	      ...
	      (<AND <ACTION? USE-MIX>
	       ...
	       <TELL
"Praxix cast some of the strange mixure at the innkeeper to see what
effect it might have." CR CR>
	       <TELL
"At first, the innkeeper sniffled a few times, then his eyes seemed to turn
red and he stared blankly, as if in a trance." CR CR>
	       <COND (<IN-PARTY? ,ESHER>
		      <TELL
...
entranced, walked from behind the counter and slugged poor Esher in the
mouth, knocking him unconscious. Then, calmly, he returned to the
counter." CR CR>
		      <FSET ,BEND-WILL-SPELL ,TRAPPED>
		      ;<GRAPHIC ,G-INNKEEPER-HITS-ESHER>)>
	       <TELL
"A few minutes later, the innkeeper seemed to recover from whatever
the spell had done to him. \"As I was saying,\" he began, then stopped.
\"What was I saying?\"">
	       <COND (<IN-PARTY? ,ESHER>
		      <TELL CR CR
...
up, I reckon, or camp out!\"">
	      ...
	      (GO-TO-ROOM
	       <COND (<NOT ,CHOSEN-BOAT>
		      <TELL ,HAVENT-CHOSEN-BOAT>
		      <REMOVE-PARTY-COMMAND ,GO-TO-ROOM-COMMAND>
		      <RTRUE>)>
	       <HINT ,HINT-INN>
	       <TELL
"Our rooms were not together; Praxix and I took one, and ">
	       <COND (<EQUAL? ,PARTY-MAX 3> <TELL "Bergon">)
		     (T <TELL "the others">)>
	       <TELL 
" took the second. It had been a strenuous day,
and a long time since we had slept in a bed. And so we fell off
into a deep and dreamless sleep." CR CR>
	       <COND (,DEMON-SEARCHING?
		      <SETG DEMON-SEARCHING? <>>
		      <GRAPHIC ,G-ZAN-FIRE ;,G-INN-FIRE>
		      <TELL
"But our slumber turned into horror, as we were awakened by shouting
...
time to escape through our window, acrid fumes filling our lungs." CR CR>
		      <TELL
...
the innkeeper replied with a mischievous giggle. \"Bye now!\"">)>
	       <MOVE-TO ,ZAN-2>)>)>

<CONSTANT HAVENT-CHOSEN-BOAT
"It seemed like time to retire, but Bergon wouldn't hear of it. \"We
...
<ROOM JAIL
      ...
      (ACTION
       <ACOND ()
	      (CALL-SHERIFF:REMOVE
	       <TELL
"We tried calling for the sheriff, but he just yelled back at us, \"I'm
trying to get some sleep! It turns out I'm not only the sheriff around here,
...
" then, the sheriff unlocked the cell door and motioned us outside." CR CR>
	       <TELL
"I waved my hand before the sheriff's eyes, but he did not
flinch. \"Potent stuff,\" I said, \"Reminds me of the winner of
last year's ale drinking contest.\"" CR CR>
...
the sheriff finally arrived; he did not seem pleased." CR CR>
		      <TELL
...
worst, but it never came. Rather, the sheriff started to chuckle." CR CR>
			     <TELL
"\"Hell,\" he said, \"that's one I haven't seen before. Now you boys keep
...
to make one of our party invisible. Praxix seemed intrigued by the
...
we were convicted of burning down the old inn">
	 <COND (<FSET? ,GRAY-STONE ,INCAPACITATED>
		<TELL ", as well as assault and petty theft">)>
	 <TELL
...
the conclusion that escape would be difficult, if not impossible.
Our possessions having been taken from us, there was little we could
do but wait." CR CR>
		 <TELL
"\"If we only had our things,\" Bergon said, \"we might have some
chance of escaping.\"">
		 <COND (<NOT <FSET? ,GRAY-STONE ,INCAPACITATED>>
			<TELL CR CR
"\"I have some of my things,\" Praxix replied, removing his pouch of
