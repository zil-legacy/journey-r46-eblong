...
<ROOM FOREST-FORK
      (TRAVEL-COMMANDS NORTH-ROUTE-COMMAND SOUTH-ROUTE-COMMAND
       		       NUL-COMMAND)
      (FLAGS ADVISE)
      (GRAPHIC G-FOREST ;G-FOREST-FORK)
      (ACTION
       <ACOND ()
	      (GET-ADVICE:REMOVE
	       <TELL
...
place described by Astrix as the Dwarvish gate of Bern i-Fen.">
	       <MOVE-TO ,FOREST-GATE ,FOREST-NIGHT>)
	      (SOUTH-ROUTE
	       <TELL
...
things, and we walked to the spot Astrix had indicated contained the
invisible gate." CR CR>
	       <TELL
...
as we started into the darkness. Praxix took out some earth and fire
essences and applied them to his staff, which shone in a pale red light.">
	       <FSET ,PRAXIX ,LIT>
	       <MOVE-TO ,BERN-I-FEN>)>)>
